...
public class Delivery_Whatsapp_SMS {
	...
	public static void Send_SMS(String Response) {
		...
		System.out.println("\nDo you want to send this weather details to Whatapp SMS message \n to your number :"+"\n"
				+ "1. Yes" +"\n"
				+ "2. No\n");
		...
		if(sms==1) {
			...
			if(setup==1) {
				...
				System.out.print("\n Enter your FROM phone number to send Whatapp SMS message with country code like +91 for INDIA:\n ");  
				String from_number= fnum.nextLine(); 
				
				Scanner tnum= new Scanner(System.in);  
				System.out.print("\n Enter your TO phone number to send Whatapp SMS message with country code like +91 for INDIA: \n");  
